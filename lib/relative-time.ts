 ...
 * timestamps (H1) — e.g. "2 hours ago". Anything under a minute reads as "now",
 * which also covers the "now" timestamp H2 calls for on an optimistically
 * prepended own-comment.
 */
